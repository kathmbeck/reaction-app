...
const apiClient = {
  ...
  createList: function(newListInfo, callback) {
    return axios
      .post(routes.CREATE_LIST_URL, newListInfo)
      .then(unwrapData)
      .then(callback)
      .catch(logError)
  },
  editList: function(listId, newListInfo, callback) {
    return axios
      .put(`${routes.EDIT_LIST_URL}/${listId}`, newListInfo)
      .then(unwrapData)
      .then(callback)
      .catch(logError)
  },
